...
import type { StudentType, StudentExcel } from "@/Types/StudentType"; // define el tipo si lo tienes
...
export const deleteEstudiante = (id: string) => api.delete(`/students/${id}`);

// Crear estudiantes por excel
export const createEstudiantesFromExcel = (payload: { students: StudentExcel[] }) =>
  api.post("/students/insert-excel", payload);
