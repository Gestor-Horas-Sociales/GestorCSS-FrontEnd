...
export default function HoursPage() {
  ...
  const filteredRegistros = registrosHoras.filter((registro) => {
    ...
    const matchesTipo = !filterTipoHoras || registro.tipo_horas === filterTipoHoras
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Registro, validación y seguimiento de horas sociales y profesionales</p>
        </div>
          ...
          <Dialog open={isNewRecordModalOpen} onOpenChange={setIsNewRecordModalOpen}>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <Select>
                      ...
                      <SelectContent>
                        <SelectItem value="1">María González - 00123456</SelectItem>
                        <SelectItem value="2">Carlos Martínez - 00123457</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
                ...
                <div>
                  <label className="text-sm font-medium">Descripción de Actividades</label>
                  <Textarea placeholder="Describe las actividades realizadas durante estas horas..." rows={3} />
                </div>
                ...
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                    ...
                    <p className="text-xs text-gray-500 mt-1">Formatos: PDF, JPG, PNG (máx. 10MB)</p>
                  </div>
                </div>

                <div className="flex justify-end gap-2 mt-4">
                  <Button variant="outline" onClick={() => setIsNewRecordModalOpen(false)}>
                    Cancelar
                  </Button>
        ...
        <CardContent>
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <Select value={filterTipoHoras} onValueChange={setFilterTipoHoras}>
                <SelectTrigger className="w-[150px]">
              ...
              <TableBody>
                {filteredRegistros.map((registro) => (
                  <TableRow key={registro.id}>
                    <TableCell>
                      <div>
                        <div className="font-medium">{registro.estudiante.nombre}</div>
                        <div className="text-sm text-muted-foreground">
                          {registro.estudiante.carnet} • {registro.estudiante.carrera}
                        </div>
                      </div>
                    </TableCell>
                    <TableCell>
                      <div>
                        <div className="font-medium">{registro.proyecto.nombre}</div>
                    ...
                    <TableCell>
                      <div className="text-center">
                        <div className="text-lg font-bold">{registro.horas}</div>
                        <div className="text-xs text-muted-foreground">horas</div>
                      </div>
                    </TableCell>
                    <TableCell>{new Date(registro.fecha).toLocaleDateString("es-ES")}</TableCell>
                    <TableCell>
                      <Badge variant={registro.tipo_horas === "sociales" ? "default" : "secondary"}>
                        {registro.tipo_horas}
                      </Badge>
                    </TableCell>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm">{registro.evidencias.length}</span>
                      </div>
                    </TableCell>
