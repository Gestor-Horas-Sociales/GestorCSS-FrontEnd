            ...
            <div className="w-full max-w-md">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-blue-700 mt-1">
                          ...
                          institucional. Solo usuarios autorizados pueden
                          acceder.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid gap-2 text-xs">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                        <span>
                          <strong>Estudiantes:</strong> Registro y seguimiento
                          de horas
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                        <span>
                          <strong>Coordinadores:</strong> Validación y gestión
                          de proyectos
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-purple-500 rounded-full"></div>
                        <span>
                          <strong>Administradores:</strong> Gestión completa del
                          sistema
                        </span>
                      </div>
                    </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-xs text-slate-400">
                  © 2024 Universidad Centroamericana "José Simeón Cañas". Todos
